...
echo 'create "assembly_genome_index", "d" | hbase shell'
echo 'create "dna_genome_index", "d" | hbase shell'
echo 'create "dna_assembly_index", "d" | hbase shell'
echo 'create "feature_genome_index", "d" | hbase shell'
echo 'create "feature_assembly_index", "d" | hbase shell'
echo 'create "feature_dna_index", "d" | hbase shell'
echo 'create "protein_genome_index", "d" | hbase shell'
echo 'create "protein_assembly_index", "d" | hbase shell'
echo 'create "protein_dna_index", "d" | hbase shell'
echo 'create "protein_feature_index", "d" | hbase shell'
